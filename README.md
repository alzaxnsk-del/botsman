...
> Installation is being finalized. The intended flow:

```bash
curl -sSL https://get.botsman.dev | bash
```
...
Full setup, including the DNS wildcard record, is in [docs/install.md](docs/install.md).
